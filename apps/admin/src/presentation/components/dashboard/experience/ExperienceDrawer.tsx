...
import type { ExperienceDetail, CreateExperienceRequest, UpdateExperienceRequest } from 'shared-types';
import { ExperienceForm } from './ExperienceForm';

interface ExperienceDrawerProps {
  open: boolean;
  editData?: ExperienceDetail | null;
  isSubmitting?: boolean;
  onClose: () => void;
  onSubmit: (values: CreateExperienceRequest | UpdateExperienceRequest) => Promise<void>;
}

export function ExperienceDrawer({ open, editData, isSubmitting, onClose, onSubmit }: ExperienceDrawerProps) {
