    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-[16px] w-full">
        ...
        <div className="flex items-start gap-[15.99px]">
          <button className="bg-transparent flex items-center gap-[7.99px] border border-[#00f0ff] px-[17px] py-[9px] rounded-[2px] text-[#00f0ff] font-['Space_Grotesk',sans-serif] font-normal text-[14px] leading-[20px] hover:bg-[rgba(0,240,255,0.05)] transition-colors cursor-pointer">
            <Image src="/assets/dashboard/icon-plus.svg" alt="" width={8.167} height={8.167} />
            New Project
          </button>
          <button className="border-0 relative flex items-center gap-[8px] px-[16px] py-[9px] rounded-[2px] bg-[#00f0ff] text-[#006970] font-['Space_Grotesk',sans-serif] font-normal text-[14px] leading-[20px] hover:bg-[#22d3ee] transition-colors shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] cursor-pointer">
                  ...
                  <div className="bg-[rgba(255,255,255,0.05)] h-[6px] rounded-[12px] overflow-hidden relative w-full">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: metric.glow ? '0px 0px 8px 0px rgba(78,222,163,0.5)' : undefined,
                      }}
                    />
                  </div>
                </div>
